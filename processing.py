# --- FILE: processing.py (Simple, Non-Streaming Version) ---
...
# ... The other helper functions are correct and unchanged ...
def create_highlighted_pdf(source_pdf_path, output_pdf_path, invalid_links, color_name="Yellow"):
    ...
    highlight_color = COLOR_MAP.get(color_name, (1, 1, 0)); doc = fitz.open(source_pdf_path); target_links = set(invalid_links)
    for page in doc:
        for link in page.get_links():
